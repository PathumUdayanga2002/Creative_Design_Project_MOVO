  ...
  return (
    <>
      <div className="flex min-h-screen">
        {/* Sidebar Section */}
        <Sidebar className="w-1/4 h-full p-0" />
        
        {/* Main Content Section */}
        <div className="flex-1 flex items-center justify-center bg-gradient-to-r from-white via-orange-200 to-white p-6 text-white">
          <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-lg">
            ...
            <button
              onClick={toggleHelp}
              className="mt-4 p-2 bg-orange-500 text-white rounded-lg shadow-md hover:bg-orange-600"
            >
              {showHelp ? "Hide Help" : "Show Help"}
            </button>

            {showHelp && (
              <div className="mt-4 p-4 bg-orange-300 rounded-lg shadow-inner text-gray-800">
